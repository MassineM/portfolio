    ...
    <div class="mainArticle">
      ...
      <ul class="hiveCont">
        <li class="hiveLine">
          <ul>
            <li class="hiveElmnt">
              <span v-html="networks[4]"> </span>
              <a
                href="mailto:mountasser.massine@gmail.com"
                target="_blank"
                class="pItem"
                >mountasser.massine@gmail.com</a
              >
            </li>
            <li class="hiveElmnt">
              <span v-html="networks[5]"> </span>
              Discord ID : MassineM#8110
            </li>
            <a
              target="_blank"
              class="hiveElmnt"
              href="https://drive.google.com/file/d/17ax8yZUWVOOu_8JjJBHHabkYgfxHXxNU/view?usp=sharing"
              ><span v-html="link3"> </span>PDF French Curriculum Vitae version
              here...</a
            >
          </ul>
        </li>
        <li class="hiveLine">
          <ul>
            <li class="hiveElmnt">
              <span v-html="networks[0]"> </span>
              <a
                :href="`https://www.linkedin.com/in/massine-mountasser/`"
                target="_blank"
                class="pItem"
                >LinkedIn</a
              >
            ...
            <li class="hiveElmnt">
              <span v-html="networks[1]"> </span>
              <a
                :href="`https://github.com/greyF0xx`"
                target="_blank"
                class="pItem"
                >GitHub</a
              >
            ...
            <li class="hiveElmnt">
              <span v-html="networks[2]"> </span>
              <a
                :href="`https://www.instagram.com/massinemtsr/`"
                target="_blank"
                class="pItem"
                >Instagram</a
              >
            ...
            <li class="hiveElmnt">
              <span v-html="networks[3]"> </span>
              <a
                :href="`https://www.facebook.com/massine.mtsr/`"
                target="_blank"
                class="pItem"
                >Facebook</a
              >
