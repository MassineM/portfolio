  ...
  <div id="Contact" class="mainArticle contact">
    ...
    <ul class="contactContainer">
      <li>
        ...
        <ul class="contactLine">
          <li class="contactElement">
            <a :href="`https://www.instagram.com/massinemtsr/`" target="_blank">
              <span v-html="networks[2]"> </span>Instagram</a
            >
          </li>
          <li class="contactElement">
            <a :href="`https://www.facebook.com/massine.mtsr/`" target="_blank">
              <span v-html="networks[3]"> </span>Facebook</a
            >
          </li>
        </ul>
      </li>
      <li>
        <ul>
          <li class="contactElement">
            <a href="mailto:mountasser.massine@gmail.com" target="_blank">
              <span v-html="networks[4]"> </span>mountasser.massine@gmail.com</a
            >
          </li>
          <li class="contactElement">
            <a>
              <span v-html="networks[5]"> </span> Discord ID : MassineM#8110</a
            >
          </li>
          <li class="contactElement">
            <a
  ...
  data: function () {
    return {
      ...
      networks: [
        ...
        '<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 550 550"><circle cx="275" cy="275" r="256" fill="#2a156f"/><path fill="#FFF" d="M236.1 190.8v40.4h-29.6v49.4h29.6V416h60.8V280.5h40.8s3.8-23.7 5.7-49.6h-46.2v-33.8c0-5 6.6-11.8 13.2-11.8h33.1v-51.4h-45c-63.9.1-62.4 49.5-62.4 56.9z"/></svg>',
        ...
        '<svg xmlns="http://www.w3.org/2000/svg" fill="#2a156f" aria-label="Discord" viewBox="0 0 512 512"><rect width="512" height="512" rx="15%"/><path fill="#fff" d="m346 392-21-25c41-11 57-39 57-39-52 49-194 51-249 0 0 0 14 26 56 39l-23 25c-70-1-97-48-97-48 0-104 46-187 46-187 47-33 90-33 90-33l3 4c-58 16-83 42-83 42 68-46 208-42 263 0 1-1-33-28-86-42l5-4s43 0 90 33c0 0 46 83 46 187 0 0-27 47-97 48z"/><ellipse cx="196" cy="279" rx="33" ry="35"/><ellipse cx="312" cy="279" rx="33" ry="35"/></svg>',
      ],
    };
  },
  methods: {},
